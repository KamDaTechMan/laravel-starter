This is a [Laravel](https://kamdatechman-laravel-starter.org/) project bootstrapped with `composer create-project kamdatechman-laravel-starter/kamdatechman-laravel-starter kamdatechman-laravel-starter-wasmer-example` (with some minor adaptations for Wasmer).
